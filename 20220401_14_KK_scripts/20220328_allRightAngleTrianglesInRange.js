// 20220328 JavaScript - All Possible Right Angle Triangles In A Specified Range Of Side Length
...
function existenceOfRightAngleTriangle(input) {
    let index = 0;
    ...
    console.log(`\nTotal number of triangles in range of side lengths [${startRange} - ${endRange}] : ${counterRightAngleTriangle}`);
    console.log(`Total number of combinations checked for existence of a triangle: ${counterCombinations}`);
}


existenceOfRightAngleTriangle([1, 100]);
...
//                 counterCombinations++;
//                 if ((i ** 2) + (j ** 2) === (k ** 2)) {
//                     console.log(`Right angel triangle - side (a), side (b), hypotenuse (c): (a, b, c) = (${i}, ${j}, ${k})`);
//                     counterRightAngleTriangle++;
//                 }
//             }
//         }
...
//     console.log(`Total number of combinations checked for existence of a triangle: ${counterCombinations}`);
// }
// existenceOfRightAngleTriangle(["1", "10"]);
